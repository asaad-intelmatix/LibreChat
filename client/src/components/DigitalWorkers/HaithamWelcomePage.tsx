  ...
  return (
    <div className="flex min-h-full items-center justify-center px-40 py-24">
      <div className="flex w-full max-w-[1432px] items-center justify-between">
        {/*  Content */}
        <div className="flex w-[561px] flex-col gap-12 ltr:text-left">
        ...
        <div className="relative">
          ...
          <div className="absolute left-[23.92px] top-[21.36px] size-[489.459px] rtl:right-[23.92px]">
            <div
              className="absolute inset-0 rounded-full"
              style={{
                background:
          ...
          <div className="relative left-[38.44px] top-[38.44px] size-[456.145px] rtl:right-[38.44px]">
            <video
              ref={videoRef}
